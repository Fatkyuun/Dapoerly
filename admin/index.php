...
<head>
  ...
  <title>Beranda - Dapoerly Admin</title>
...
<body>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6>Fathir Alamsyah Mahardika</h6>
              <span>Admin</span>
            </li>
            <li>
      ...
      <div class="row">
            ...
            <div class="col-12">
              <div class="card info-card customers-card shadow-sm w-100">
                <div class="card-body text-center py-4">
                  <h4 class="mb-2">Selamat Datang di Website Admin <strong>Dapoerly!</strong></h4>
        ...
        <div class="col-xxl-4 col-md-6">
          <div class="card info-card sales-card">
            <div class="card-body">
              <h5 class="card-title">Pesanan <span>| Semua Maktu</span></h5>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      Designed by <a href="https://instagram.com/fatkyuun/" target="_blank">Fathir Alamsyah Mahardika</a>
    </div>
  </footer><!-- End Footer -->
